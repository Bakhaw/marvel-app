...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="h-[320px] min-w-[300px] max-w-[600px] flex flex-col p-6 rounded-[48px] bg-gray-800/25 border-[0.5px] border-fuchsia-300 transition-all hover:bg-fuchsia-300/10 hover:border-fuchsia-400 hover:scale-[1.005]">
      ...
      <div className="mb-5">
        <h2 className="max-w-[300px] truncate text-lg text-gray-400 hover:underline hover:text-gray-400/60">
          {subtitle}
        </h2>
        <h1 className="max-w-[300px] truncate text-2xl text-gray-200 hover:text-white">
          {title}
        </h1>
      </div>
